...
import MobileMenu from './mobile-menu.js?v=20260910-4';
...
class Navbar {
  ...
  async loadCategories() {
    try {
      ...
      const taxonomyUrls = ['./product-taxonomy.json', './auto-parts-taxonomy.json', './digital-download-taxonomy.json', './hair-taxonomy.json'];
