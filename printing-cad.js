  ...
  render() {
    ...
    this.container.innerHTML = `
      <style>
        ...
        .quiz-summary{display:grid;gap:.8rem;border:1px solid rgba(31,30,28,.08);border-radius:1.35rem;background:linear-gradient(180deg,rgba(255,255,255,.98),rgba(248,242,230,.9));padding:1.1rem}.quiz-summary-row,.quiz-summary-total{display:flex;justify-content:space-between;gap:1rem;color:#6E6557}.quiz-summary-total{margin-top:.25rem;padding-top:.9rem;border-top:1px solid rgba(31,30,28,.08);color:#0F1111;font-size:1.2rem;font-weight:800}
        ...
        .quiz-actions{display:flex;flex-wrap:wrap;gap:.8rem;align-items:center}.quiz-btn{border:none;border-radius:999px;padding:.96rem 1.25rem;font:inherit;font-weight:800;cursor:pointer}.quiz-btn.primary{background:#0F1111;color:#F8F5EF}.quiz-btn.secondary{background:#fff;color:#0F1111;border:1px solid rgba(31,30,28,.12)}.quiz-btn.ghost{background:transparent;color:#6E6557;border:1px solid rgba(31,30,28,.1)}
