  ...
  render() {
    ...
    this.container.innerHTML = `
      <style>
        ...
        .quiz-actions{display:flex;flex-wrap:wrap;gap:.8rem;align-items:center}.quiz-btn{border:none;border-radius:999px;padding:.96rem 1.25rem;font:inherit;font-weight:800;cursor:pointer;text-decoration:none;display:inline-flex;align-items:center;gap:.65rem}.quiz-btn.primary{background:#0F1111;color:#F8F5EF}.quiz-btn.ghost{background:transparent;color:#6E6557;border:1px solid rgba(31,30,28,.1)}.quiz-btn.whatsapp{background:#25D366;color:#fff}.quiz-btn.is-disabled{opacity:.5;pointer-events:none}
