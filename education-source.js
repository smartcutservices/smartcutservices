...
import * as demoSource from './education-demo-source.js?v=20260831-4';
import * as repository from './education-repository.js?v=20260831-4';

export { EducationRepositoryError } from './education-repository.js?v=20260831-4';
