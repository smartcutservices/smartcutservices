  ...
  renderWhatsAppView(colors, fonts) {
    ...
    return `
      <section class="sc-wa-preferences" style="--sc-wa-title:${colors.text.title};--sc-wa-body:${colors.text.body};--sc-wa-font:${fonts.primary};">
        ...
        <style>
          .sc-wa-preferences,.sc-wa-form,.sc-wa-card,.sc-wa-departments,.sc-wa-department-grid{box-sizing:border-box;min-width:0}.sc-wa-preferences{width:100%;scrollbar-gutter:stable}.sc-wa-actions{padding-bottom:18px}.sc-wa-select-all{border:1px solid #b9cfe3;border-radius:999px;background:#f5faff;color:#1769aa;padding:7px 11px;font:700 12px/1 inherit;cursor:pointer;white-space:nowrap}.sc-wa-select-all:hover{background:#eaf4ff;border-color:#1769aa}@media(min-width:561px){.sc-wa-preferences{height:calc(100dvh - 210px);max-height:none;padding:1px 14px 44px 1px;scroll-padding-bottom:44px}.sc-wa-departments{max-height:none;overflow:visible;padding-right:0}}@media(max-width:560px){.sc-wa-actions{padding-bottom:0}.sc-wa-departments{max-height:none;overflow:visible}}
        </style>
