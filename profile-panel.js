  ...
  renderWhatsAppView(colors, fonts) {
    ...
    return `
      <section class="sc-wa-preferences" style="--sc-wa-title:${colors.text.title};--sc-wa-body:${colors.text.body};--sc-wa-font:${fonts.primary};">
        ...
        <style>
          .sc-wa-preferences,.sc-wa-form,.sc-wa-card,.sc-wa-departments,.sc-wa-department-grid{box-sizing:border-box;min-width:0}.sc-wa-preferences{width:100%;scrollbar-gutter:stable}.sc-wa-actions{padding-bottom:18px}@media(min-width:561px){.sc-wa-preferences{height:calc(100dvh - 210px);max-height:none;padding:1px 14px 44px 1px;scroll-padding-bottom:44px}.sc-wa-departments{max-height:min(46dvh,430px);overflow-y:auto;overscroll-behavior:contain;padding-right:6px}.sc-wa-departments::-webkit-scrollbar{width:7px}.sc-wa-departments::-webkit-scrollbar-thumb{border-radius:99px;background:#cad6e2}}@media(max-width:560px){.sc-wa-actions{padding-bottom:0}.sc-wa-departments{max-height:none;overflow:visible}}
        </style>
