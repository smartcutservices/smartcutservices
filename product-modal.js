...
">
  ...
  renderProductInfo() {
    ...
    const whatsappMessage = [
      'Bonjou Smart Cut Services, mwen bezwen asistans pou pwodwi sa a:',
      product.name || 'Pwodwi Smart Cut',
      productUrl.href
    ].join('\n');
    const whatsappSupportUrl = `https://wa.me/50934913988?text=${encodeURIComponent(whatsappMessage)}`;
    
    return `
      <div class="product-info-stack" style="display: flex; flex-direction: column; gap: 1.5rem;">
        <!-- Nom -->
        ...
        <div class="product-trust-strip" aria-label="Informations avant achat">
          ...
          <a class="product-trust-item product-whatsapp-support" href="${whatsappSupportUrl}" target="_blank" rel="noopener noreferrer" onclick="event.stopPropagation();" aria-label="Contacter Smart Cut Services sur WhatsApp au +509 3491-3988" style="color:inherit;text-decoration:none;cursor:pointer;">
            ...
            <span>WhatsApp Smart Cut<br><strong>+509 3491-3988</strong></span>
          </a>
        </div>
  ...
  renderOptions() {
    ...
    if (Array.isArray(this.product.variations) && this.product.variations.length > 0) {
      options.push(`
        <div class="option-group">
          ...
          <div class="variation-scroll-row" style="display: flex; flex-wrap: wrap; gap: 0.5rem;">
    ...
    return options.length > 0 ? `
      <div class="product-options-stack" style="display: flex; flex-direction: column; gap: 1rem; padding-top: 1rem; border-top: 1px solid rgba(198, 167, 94, 0.2);">
        ${options.join('')}
      </div>
    ` : '';
  }
  ...
  renderRelatedProducts() {
    ...
    return `
      <div class="product-related-section" style="margin-top: 2rem; padding-top: 1.5rem; border-top: 1px solid rgba(198, 167, 94, 0.2);">
