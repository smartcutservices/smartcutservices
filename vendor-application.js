              ...
              <div style="display:grid;gap:1rem;">
                ...
                ${status === 'approved' ? `
                  <div style="display:grid;gap:.9rem;">
                    ...
                    <a href="${VENDOR_DASHBOARD_URL}" id="vendorDashboardAccessBtn" style="display:inline-flex;align-items:center;gap:.65rem;text-decoration:none;border-radius:999px;background:#0F1111;color:#F8F5EF;padding:1rem 1.2rem;font-weight:800;">
