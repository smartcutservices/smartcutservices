...
class SmartCutHealth {
  ...
  render() {
    ...
    this.root.innerHTML = `<div class="health-shell">
      ...
      <section class="health-module-entry"><div class="health-wrap"><div class="health-module-heading"><span class="health-eyebrow">Smart Cut Health</span><h2>Choisissez votre espace.</h2></div><div class="health-module-grid">
        <a class="health-module-card health-module-card--patient" href="./health-espace.html"><span class="health-module-icon"><i class="fas fa-heart-pulse"></i></span><span><strong>Mon espace</strong><small>Rendez-vous, ordonnances, commandes et résultats.</small></span><i class="fas fa-arrow-right"></i></a>
  ...
  notifIcon(type) {
    const map = {
      ...
      order_cancelled: 'fa-ban', order_status_changed: 'fa-truck', lab_result_available: 'fa-vial-circle-check',
      imaging_result_available: 'fa-x-ray', session_message: 'fa-message', appointment_status_changed: 'fa-calendar-day'
    };
